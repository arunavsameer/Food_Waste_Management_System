  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:'20px' }}>
      ...
      <div style={{
        ...
        {filterMess !== 'all' && <><span style={{ color:'var(--border-color)' }}>·</span><span style={{ fontSize:'0.82rem', fontWeight:700, color:'var(--primary-blue)' }}>{filterMess}</span></>}
        {filterMeal !== 'all' && <><span style={{ color:'var(--border-color)' }}>·</span><span style={{ fontSize:'0.82rem', fontWeight:700, color:'var(--primary-blue)', textTransform:'capitalize' }}>{filterMeal} only</span></>}
      ...
      <div style={{
        ...
        <input className="admin-search" placeholder="Search mess…" value={search} onChange={e=>setSearch(e.target.value)} style={{ marginLeft:'auto' }}/>

        <button className="icon-btn" onClick={fetchReports} title="Refresh"><RefreshCw size={15} className={loading?'spin':''}/></button>
